    ...
    <AnimatePresence>
      {open ? (
        ...
        >
          ...
          <p className="border-b border-line bg-surface/50 px-4 py-2 text-[11px] leading-relaxed text-muted-foreground">
            Private notes — stored only in this browser on this device. They are never sent to the
